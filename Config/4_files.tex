...
%              \ntaddfile{chapter}[phd,phdplan]{my-chapter} % just both phd and
%              phdplan documents
\ntaddfile{chapter}{INTRO}
\ntaddfile{chapter}{STATE-ART}
\ntaddfile{chapter}{DESIGN}
\ntaddfile{chapter}{IMPLEM}
\ntaddfile{chapter}{EVAL}
\ntaddfile{chapter}{CONCL}
%% >>>> Template
...
%% >>>> Template
\ntaddfile{appendix}{appendix-taxonomy}
% \ntaddfile{appendix}{appendix-src-code}
% \ntaddfile{appendix}{appendix-cfg}
% \ntaddfile{appendix}{appendix-logs}
