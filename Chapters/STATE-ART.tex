...
The commercial software solutions do not provide the security mechanisms
...
% for system's operation, and the \gls{hal} abstracts the underlying hardware. The
...
% The commercial software solutions lack security mechanisms, rendering it
