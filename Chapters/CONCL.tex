...
\item \textbf{Extended \gls{uav} benchmarking}
  ...
  need to collect and analyze additional data from relevant PX4 topics to
  support mission diagnostics and benchmarking. Furthermore, while initial functional
  tests demonstrated isolation, future work should design and execute more
  sophisticated, long-duration attack scenarios and stress tests, e.g., under
  high guest interference. This would further validate the trustworthiness and
  resilience of the \gls{sspfs} under adversarial conditions.
